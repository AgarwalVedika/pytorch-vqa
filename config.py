...
#
# preprocessed_path = './preprocessed_data/resnet-14x14.h5'      ### THIS IS USED IN THE CODE  ### train + val + test
...
preprocessed_path = './preprocessed_data/edit_trainset.h5'         #edit_valset.h5'      ### THIS IS USED IN THE CODE
...
#preprocessed_train_path = './preprocessed_data/edit_trainset.h5'  # path where preprocessed features are saved to and loaded from
#preprocessed_val_path = './preprocessed_data/flipped_edit_valset.h5'  # path where preprocessed features are saved to and loaded from
#preprocessed_test_path = './preprocessed_data/edit_testset.h5'  # path where preprocessed features are saved to and loaded from
