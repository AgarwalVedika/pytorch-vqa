...
# import numpy
#
# # FUTURE TODO- chang everything to S25- then just in the data_loader: if image_id type is int- you first do np.string_(str(img_id).zfill(25)) in CocoImages in data.py
#
# parser = argparse.ArgumentParser()
# #parser.add_argument('--split', required=True, type=str)  ### train2014/val2014/test2015/edit_orig
...
#             else:
#                 coco_ids[i:j] = ids.numpy().astype('int')  # ### TODO vedika made it iimage_id) : for future purpose- maybe a good idea to id originla images as int
#             i = j
#
#
